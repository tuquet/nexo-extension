...
import { generateScript, suggestPlotPoints } from '@src/services/background-api';
...
const CreationForm: React.FC<{
  ...
  isLoading: boolean;
  onCancel: () => void;
}> = ({ onGenerate, onImportJson, onImportFile, isLoading }) => {
        ...
        <TabsContent value="ai" className="mt-6">
          <form onSubmit={handleGenerate} className="space-y-6">
            ...
            <div>
              ...
              {/* ModelSettings component is available in parent scope; if not, import accordingly */}
            </div>
            <div className="pt-2">
              <Button
                type="submit"
